...
@section('title', 'Tambah Kehadiran Siswa - Guru')
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold text-gray-800">Tambah Kehadiran Siswa - Kelas yang Anda Ajar</h2>
                        <a href="{{ route('guru.attendances.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                            Kembali
                        </a>
                    </div>
                    <form method="POST" action="{{ route('guru.attendances.store') }}" id="attendanceForm">
                        @csrf

                        <!-- Step 1: Select Kelas -->
                        <div class="mb-6">
                            <label for="class_id" class="block text-sm font-medium text-gray-700 mb-2">Pilih Kelas yang Anda Ajar</label>
                        ...
                        <div class="mb-6" id="scheduleSection" style="display: none;">
                            <label for="schedule_id" class="block text-sm font-medium text-gray-700 mb-2">Pilih Jadwal Mengajar Anda</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadStudents(classId) {
                // Fetch students for the selected class using JSON endpoint
                fetch(`/guru/classes/${classId}/students/json`)
