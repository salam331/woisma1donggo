<aside x-data="{ open: true }" :class="open ? 'w-64' : 'w-16'"
    ...
    <nav class="flex flex-col flex-1 py-6 space-y-2 overflow-y-auto">      
        ...
        {{-- Dashboard publik --}}
        <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 px-3 py-2 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-100 
              dark:hover:bg-gray-800 transition-colors duration-200">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <span x-show="open" class="transition-opacity duration-300">Dashboard Publik</span>
        </a>
