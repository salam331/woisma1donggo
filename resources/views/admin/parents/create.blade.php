        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">Tambah Orang Tua Baru</h2>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="relationship" required
                                    ...
                                    <option value="father" {{ old('relationship') == 'father' ? 'selected' : '' }}>Ayah
                                    </option>
                                    <option value="mother" {{ old('relationship') == 'mother' ? 'selected' : '' }}>Ibu
                                    </option>
                                    <option value="guardian" {{ old('relationship') == 'guardian' ? 'selected' : '' }}>Wali
                                    </option>
                                </select>
                                @error('relationship')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
