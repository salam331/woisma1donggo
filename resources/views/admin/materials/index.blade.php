                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($materials as $material)
                            <tr class="hover:bg-gray-50">
                                ...
                                {{-- JUDUL --}}
                                <td class="px-6 py-4 whitespace-nowrap" data-label="Judul">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500">
                                                {{ Str::limit($material->description, 10) }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                {{-- SUBJECT --}}
                                <td class="px-6 py-4 text-sm text-gray-900" data-label="Mata Pelajaran">
                                    {{ $material->subject->name ?? '-' }}
                                </td>

                                {{-- TEACHER --}}
                                <td class="px-6 py-4 text-sm text-gray-900" data-label="Guru">
                                    {{ $material->teacher->name ?? '-' }}
                                </td>

                                {{-- FILE TYPE --}}
                                <td class="px-6 py-4" data-label="Tipe File">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        {{ str::limit($material->file_type, 15) }}
                                    </span>
                                </td>

                                {{-- FILE SIZE --}}
                                <td class="px-6 py-4 text-sm text-gray-500" data-label="Ukuran">
                                    {{ number_format(Storage::disk('public')->size($material->file_path) / 1024, 1) }} KB
                                </td>

                                {{-- ACTIONS --}}
                                <td class="px-6 py-4 text-sm text-gray-500" data-label="Aksi">
                                    ...
                                    <div class="flex items-center justify-center gap-x-4">
                                        ...
                                        <a href="{{ route('admin.materials.download', $material) }}"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.8" stroke="currentColor" class="w-5 h-5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M12 3v12m0 0l-4-4m4 4l4-4m-8 8h8a2 2 0 002-2v-2" />
                                            </svg>
                                        </a>
