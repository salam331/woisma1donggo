    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-200 mb-4">
                    Jadwal Pelajaran ({{ $subject->schedules->count() }})
                </h3>
                                    ...
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <span class="text-sm font-medium text-blue-600">
                                                {{ substr($schedule->class->name ?? 'N/A', 0, 2) }}
                                            </span>
                                        </div>

                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                                {{ $schedule->class->name ?? 'Kelas Tidak Ditemukan' }}
                                            </div>
                                            <div class="text-sm text-gray-500 dark:text-gray-300">
                                                {{ $schedule->day }} -
                                                {{ $schedule->start_time }} sampai
                                                {{ $schedule->end_time }}
                                            </div>
                                        </div>
                                    </div>
                ...
                @else
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 text-center">
                        <p class="text-gray-500 dark:text-gray-300">
                            Belum ada jadwal pelajaran untuk mata pelajaran ini.
                        </p>
                    </div>
                @endif
                ...
                <div class="mt-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('admin.subjects.edit', $subject) }}"
                            class="block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-900">
                        ...
                        <button
                            class="block w-full text-left px-4 py-2 text-sm text-red-700 bg-white dark:bg-gray-800 border border-red-300 dark:border-red-700 rounded-md hover:bg-red-50 dark:hover:bg-red-900">
