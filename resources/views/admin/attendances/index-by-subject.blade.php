                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 table-responsive">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-600 dark:text-gray-300 uppercase">
                                Aksi
                            </th>
                        </tr>
                    </thead>
                        ...
                        @forelse($students as $student)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td data-label="Nama Siswa"
                                    class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-200">
                                    {{ $student->name }}
                                </td>
                                <td data-label="NIS" class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-200">
                                    {{ $student->nis }}
                                </td>
                                <td data-label="Aksi" class="px-6 py-4 text-right text-sm font-medium">
                                    <div class="flex items-center justify-center gap-x-4">
                                        <a href="{{ route('admin.attendances.student-history', ['studentId' => $student->id, 'subjectId' => $subject->id]) }}"
