...
<div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.attendances.index-by-class', $class->id) }}"
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase">Siswa</th>
                    ...
                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-600 dark:text-gray-300 uppercase">Aksi</th>
                </tr>
            </thead>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4">
                        ...
                        @elseif($attendance->status == 'absent')
                            <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">Tidak Hadir</span>
                        @elseif($attendance->status == 'late')
                            <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">Terlambat</span>
